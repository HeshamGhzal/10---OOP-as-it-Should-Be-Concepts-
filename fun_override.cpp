...
class clsdevolper :public clsemplyee
{
private:
	string _Main_Programing_languge;
public:
	clsdevolper(int Id, string FirstName, string LastName, string Email,
		string Phone, string Title, string Department, float Salary, string Programing_Languge)
		:clsemplyee(Id, FirstName, LastName, Email, Phone, Title, Department, Salary)
	{
		_Main_Programing_languge = Programing_Languge;
	}
	void set_Main_Programing_languge(string Programing_Languge)
	{
		_Main_Programing_languge = Programing_Languge;
	}
	string get_Main_Programing_languge()
	{
		return _Main_Programing_languge;
	}
	void print()//to override print fun in person class
	{
		...
		cout << "Main programing language : " << _Main_Programing_languge << endl;
		cout << string(40, '-') << endl;
	}
...
int main()
{
	...
	clsdevolper Devolper1(01, "KOKA", "Ghzal",
		"Ghzal@gmail", "0120045", "Programmer", "IT", 50000, "c++");
	Devolper1.print();
	Devolper1.Send_Email("Hi", "This Email sent to you");
	Devolper1.Send_SMS("This Txt message sent to you ");
}